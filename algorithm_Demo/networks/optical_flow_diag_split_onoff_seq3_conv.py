# optical_flow_diag_split_onoff_seq3_conv.py
# 方向: 斜向（对角线）
# 变体: split + on/off + seq3 + conv —— seq3 加上 layer_1 的 4x4 [1,2,1] 对角线卷积前端，
#       并把片上时钟调慢（slow clock）以配合更宽的核。
...
# ===========================================================================
NETWORK_NAME = "optical_flow_diag_split_onoff_seq3_conv"
