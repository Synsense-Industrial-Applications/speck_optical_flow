...
create_layer(
    layer_name="layer_4",layer=layer_4,  
    padding=1,stride=1,kernel_size=1,
...
# ===========================================================================
NETWORK_NAME = "optical_flow_diag_split_onoff_seq3_k2_conv"
...
WARNINGS = ['末层 1x1 头补边：padding 0->1，输出 62->64（四周各 1 圈零边，内容内缩 1 像素）', 'config.dvs_layer.destinations[1] 被注释：第二条 split 分支收不到 DVS 输入（Demo_SNN.py 已证实这会让 S-family features 1/2/5/6 不输出）']
